...
st.markdown(
    ...
    /* Keep Streamlit's sidebar available, but use an app-controlled
       compact rail so the expand button never disappears. */
    ...
    /* -----------------------------------------------------
       COLLAPSED SIDEBAR = THIN NAVIGATION RAIL
       ----------------------------------------------------- */
    ...
    /* Completely hide the sidebar's application content.
       The native Streamlit expand control remains outside this
       content and is styled below. */
    ...
    [data-testid="stSidebar"][aria-expanded="false"] .sidebar-section,
    [data-testid="stSidebar"][aria-expanded="false"] .sidebar-feature {
        display: none !important;
        visibility: hidden !important;
    }

    /* The collapsed-state control is the ONLY visible element. */
    /* Native Streamlit collapsed-sidebar control.
       Keep it visible above the page and outside the collapsed rail. */
    ...
    /* Evaluation progress text: force dark text in Streamlit status */
    [data-testid="stStatusWidget"],
    [data-testid="stStatusWidget"] *,
    ...
    /* Streamlit status body text — force readable dark text */
    [data-testid="stStatusWidget"] [data-testid="stMarkdownContainer"],
    [data-testid="stStatusWidget"] [data-testid="stMarkdownContainer"] *,
    [data-testid="stStatusWidget"] [data-testid="stMarkdownContainer"] p,
    [data-testid="stStatusWidget"] [data-testid="stMarkdownContainer"] span {
...
# =========================================================
# SIDEBAR — FIXED OPEN NAVIGATION
# =========================================================

# The sidebar is intentionally kept permanently open. Streamlit's native
# collapse control is hidden so the navigation remains fixed on the left.
st.markdown(
    """
    <style>
    [data-testid="stSidebar"] {
...
with st.sidebar:
    ...
    st.markdown(
        html(
            """
            <div class="sidebar-engine-content">
                ...
                st.markdown(
                    html(
                        ...
                        <div style="
                            ...
                            line-height:1.5;
                        ">
                            Evaluating {len(suppliers)} supplier proposal(s)...
                        </div>
                        '''
                    ),
                    unsafe_allow_html=True,
